...
export const POPULAR_CITIES: CityData[] = [
  // مصر - Egypt
  { name: 'Cairo', arabicName: 'القاهرة', lat: 30.0444, lng: 31.2357, country: 'مصر' },
  { name: 'Giza', arabicName: 'الجيزة', lat: 30.0131, lng: 31.2089, country: 'مصر' },
  { name: 'Alexandria', arabicName: 'الإسكندرية', lat: 31.2001, lng: 29.9187, country: 'مصر' },
  { name: 'Tanta', arabicName: 'طنطا (الغربية)', lat: 30.7865, lng: 31.0004, country: 'مصر' },
  { name: 'Mansoura', arabicName: 'المنصورة (الدقهلية)', lat: 31.0409, lng: 31.3785, country: 'مصر' },
  { name: 'Zagazig', arabicName: 'الزقازيق (الشرقية)', lat: 30.5877, lng: 31.5020, country: 'مصر' },
  { name: 'Asyut', arabicName: 'أسيوط', lat: 27.1783, lng: 31.1859, country: 'مصر' },
  { name: 'Sohag', arabicName: 'سوهاج', lat: 26.5569, lng: 31.6948, country: 'مصر' },
  { name: 'Luxor', arabicName: 'الأقصر', lat: 25.6872, lng: 32.6396, country: 'مصر' },
  { name: 'Aswan', arabicName: 'أسوان', lat: 24.0889, lng: 32.8998, country: 'مصر' },
  { name: 'Port Said', arabicName: 'بورسعيد', lat: 31.2653, lng: 32.3019, country: 'مصر' },
  { name: 'Suez', arabicName: 'السويس', lat: 29.9668, lng: 32.5498, country: 'مصر' },
  { name: 'Ismailia', arabicName: 'الإسماعيلية', lat: 30.6043, lng: 32.2723, country: 'مصر' },
  { name: 'Faiyum', arabicName: 'الفيوم', lat: 29.3084, lng: 30.8428, country: 'مصر' },
  { name: 'Beni Suef', arabicName: 'بني سويف', lat: 29.0661, lng: 31.0994, country: 'مصر' },
  { name: 'Minya', arabicName: 'المنيا', lat: 28.0871, lng: 30.7618, country: 'مصر' },
  { name: 'Damanhur', arabicName: 'دمنهور (البحيرة)', lat: 31.0414, lng: 30.4682, country: 'مصر' },
  { name: 'Shibin El Kom', arabicName: 'شبين الكوم (المنوفية)', lat: 30.5526, lng: 31.0091, country: 'مصر' },
  { name: 'Banha', arabicName: 'بنها (القليوبية)', lat: 30.4660, lng: 31.1853, country: 'مصر' },
  { name: 'Kafr El Sheikh', arabicName: 'كفر الشيخ', lat: 31.1107, lng: 30.9388, country: 'مصر' },
  { name: 'Qena', arabicName: 'قنا', lat: 26.1551, lng: 32.7160, country: 'مصر' },
  { name: 'Damietta', arabicName: 'دمياط', lat: 31.4175, lng: 31.8144, country: 'مصر' },
  { name: 'Hurghada', arabicName: 'الغردقة (البحر الأحمر)', lat: 27.2579, lng: 33.8116, country: 'مصر' },
  { name: 'Sharm El Sheikh', arabicName: 'شرم الشيخ (جنوب سيناء)', lat: 27.9158, lng: 34.3299, country: 'مصر' },
  { name: 'Marsa Matruh', arabicName: 'مرسى مطروح', lat: 31.3543, lng: 27.2373, country: 'مصر' },

  // السعودية - Saudi Arabia
  { name: 'Makkah', arabicName: 'مكة المكرمة', lat: 21.4225, lng: 39.8262, country: 'السعودية' },
  { name: 'Medina', arabicName: 'المدينة المنورة', lat: 24.4673, lng: 39.6112, country: 'السعودية' },
  { name: 'Riyadh', arabicName: 'الرياض', lat: 24.7136, lng: 46.6753, country: 'السعودية' },
  { name: 'Jeddah', arabicName: 'جدة', lat: 21.5433, lng: 39.1728, country: 'السعودية' },
  { name: 'Dammam', arabicName: 'الدمام', lat: 26.4207, lng: 50.0888, country: 'السعودية' },
  { name: 'Khobar', arabicName: 'الخبر', lat: 26.2172, lng: 50.1971, country: 'السعودية' },
  { name: 'Abha', arabicName: 'أبها', lat: 18.2164, lng: 42.5053, country: 'السعودية' },
  { name: 'Tabuk', arabicName: 'تبوك', lat: 28.3835, lng: 36.5662, country: 'السعودية' },
  { name: 'Taif', arabicName: 'الطائف', lat: 21.2854, lng: 40.4222, country: 'السعودية' },

  // الإمارات - UAE
  { name: 'Abu Dhabi', arabicName: 'أبو ظبي', lat: 24.4539, lng: 54.3773, country: 'الإمارات' },
  { name: 'Dubai', arabicName: 'دبي', lat: 25.2048, lng: 55.2708, country: 'الإمارات' },
  { name: 'Sharjah', arabicName: 'الشارقة', lat: 25.3463, lng: 55.4209, country: 'الإمارات' },

  // دول عربية أخرى
  { name: 'Kuwait City', arabicName: 'الكويت', lat: 29.3759, lng: 47.9774, country: 'الكويت' },
  { name: 'Doha', arabicName: 'الدوحة', lat: 25.2854, lng: 51.5310, country: 'قطر' },
  { name: 'Manama', arabicName: 'المنامة', lat: 26.2285, lng: 50.5860, country: 'البحرين' },
  { name: 'Muscat', arabicName: 'مسقط', lat: 23.5880, lng: 58.3829, country: 'عُمان' },
  { name: 'Amman', arabicName: 'عمان', lat: 31.9539, lng: 35.9106, country: 'الأردن' },
  { name: 'Jerusalem', arabicName: 'القدس الشريف', lat: 31.7683, lng: 35.2137, country: 'فلسطين' },
  { name: 'Gaza', arabicName: 'غزة', lat: 31.5017, lng: 34.4668, country: 'فلسطين' },
  { name: 'Beirut', arabicName: 'بيروت', lat: 33.8938, lng: 35.5018, country: 'لبنان' },
  { name: 'Damascus', arabicName: 'دمشق', lat: 33.5138, lng: 36.2765, country: 'سورية' },
  { name: 'Baghdad', arabicName: 'بغداد', lat: 33.3152, lng: 44.3661, country: 'العراق' },
  { name: 'Casablanca', arabicName: 'الدار البيضاء', lat: 33.5731, lng: -7.5898, country: 'المغرب' },
  { name: 'Rabat', arabicName: 'الرباط', lat: 34.0209, lng: -6.8416, country: 'المغرب' },
  { name: 'Algiers', arabicName: 'الجزائر العاصمة', lat: 36.7538, lng: 3.0588, country: 'الجزائر' },
  { name: 'Tunis', arabicName: 'تونس', lat: 36.8065, lng: 10.1815, country: 'تونس' },
  { name: 'Tripoli', arabicName: 'طرابلس', lat: 32.8872, lng: 13.1913, country: 'ليبيا' },
  { name: 'Khartoum', arabicName: 'الخرطوم', lat: 15.5007, lng: 32.5599, country: 'السودان' },
  { name: 'Sanaa', arabicName: 'صنعاء', lat: 15.3694, lng: 44.1910, country: 'اليمن' },
  { name: 'Istanbul', arabicName: 'إسطنبول', lat: 41.0082, lng: 28.9784, country: 'تركيا' },
  { name: 'London', arabicName: 'لندن', lat: 51.5074, lng: -0.1278, country: 'بريطانيا' },
  { name: 'New York', arabicName: 'نيويورك', lat: 40.7128, lng: -74.0060, country: 'أمريكا' },
];
