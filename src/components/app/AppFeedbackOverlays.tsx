      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            className="fixed bottom-24 start-4 end-4 md:start-auto md:end-4 md:max-w-md bg-slate-900/95 dark:bg-[#161d26]/98 backdrop-blur-md text-white px-5 py-4 rounded-2xl border border-slate-700/50 shadow-2xl z-50 flex items-start gap-3.5 text-right font-sans"
            dir="rtl"
          >
