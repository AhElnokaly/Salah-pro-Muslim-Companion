                ...
                <div className="flex items-center gap-2 pt-1">
                  {updateResult.latestRelease.apkDownloadUrl && (
                    <button
                      ...
                      className="flex-1 py-2 px-3 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 text-white font-black text-xs rounded-xl shadow-sm text-center flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
                    >
                      {isInstalling ? (
                        <>
