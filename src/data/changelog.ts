...
export const RELEASE_HISTORY: ReleaseNote[] = [
  {
    ...
    buildNumber: 111,
    date: '26 سبتمبر 2026',
    title: 'تحديث استقرار البناء الشامل وتكامل مؤشرات الإتقان الإيماني والويدجت',
    isCurrent: true,
    highlights: [
      { category: 'improvement', text: 'معالجة شاملة لكافة أخطاء الربط البرمجي ودقة حساب مؤشر الإتقان الإيماني التراكمي (يومي/أسبوعي/شهري)' },
      { category: 'fix', text: 'تكامل صلاحيات المنبهات الدقيقة وإعدادات الإشعارات لنظام أندرويد وتزامن بيانات الويدجت' },
      { category: 'feature', text: 'اكتمال بيانات منازل القمر الـ 28 وأطوار القمر الثمانية مع التوجيه العبادي وصيام النوافل' }
    ]
  },
  {
    version: '1.1.0',
