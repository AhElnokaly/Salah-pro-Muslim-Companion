...
## 3. حماية ملف المراجع (Strict REFERENCE.md Protection)
- **ملف المراجع `REFERENCE.md`:** يضم التهيئات والإعدادات الكاملة الخاصة بالمهمات الناجحة.
- **الحظر الصارم:** يُحظر تماماً التعديل على هذا الملف، أو الإضافة عليه، أو حذف أي جزء منه إلا بعد تلقي أمر كتابي صريح ومباشر من المستخدم.
