...
مرحباً بك في الدليل المرجعي الفني والتنفيذي الشامل لمشروع وتطبيق **«همّتي» (Hemmaty)**. تم تقسيم التوثيق المرجعي إلى **ثمانية أجزاء مفصلة ومستقلة** تغطي كافة الجوانب المعمارية، الحسابية، الأصلية، الصوتية، الأمان، ومنظومة البناء الآلي للتطبيق.

---

## 📚 فهرس المراجع التفصيلية (Reference Documents Index)

### 🌟 [المعمارية الشاملة وحزمة الأمان (App Architecture & Security Kit)](./docs/reference/08_APP_ARCHITECTURE_AND_SEC_KIT.md)
> **المرجع الرئيسي الجامع:** يضم مخطط التدفق المعماري الشامل (ASCII Flow Diagram)، مصفوفة مسؤوليات الطبقات، معايير أمان التوقيع الرقمي (Keystore Security)، تحصين صلاحيات أندرويد (Permissions Hardening)، والخصوصية الكاملة دون أي تتبع خارجي.
...
### 7️⃣ [منظومة البناء والتشغيل الآلي (CI/CD & Workflows)](./docs/reference/07_CI_CD_WORKFLOWS.md)
> يوثق مسارات العمل الناجحة لـ GitHub Actions (نشر الـ PWA، بناء حزم الـ APK التجريبية والموقعة)، مصفوفة التوافق للإصدارات، إدارة مفاتيح التوقيع الرقمي (Keystore Secrets)، ودليل التشخيص والحلول السريعة لأخطاء البناء.
